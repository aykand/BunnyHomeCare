...
export const blogPosts: BlogPost[] = [
   {
    ...
    content: [
      ...
      },
      {
        ...
        paragraph:
          "Yes. Families can specify their preferred language during initial intake. Discussing language needs early allows home care agencies to identify and match fully qualified, native-speaking caregivers in your local community.",
      },
      {
