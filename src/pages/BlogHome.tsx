            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-6 flex flex-col lg:flex-row gap-5 items-center justify-between">
              <div className="relative w-full lg:max-w-md">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 pl-12 pr-4 py-3 text-gray-700 focus:outline-none focus:border-[#30d5c8] focus:ring-2 focus:ring-[#30d5c8]/20"
                />
              </div>
